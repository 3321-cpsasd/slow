...
| [ADR-0023](0023-version-bound-reading-annotations.md) | Accepted，MVP 已实现 | 正文版本绑定的高亮、批注、Ask AI 历史与反馈后证据冻结边界 |
...
- 2026-08-16：完成白银、黄金、钻石阶段的复习再激活执行器：冻结新任务、原始提交和独立评定，严格检查到期、无辅助、任务独立与模型家族分离；合格证据只刷新 activation，不重复授予或降低能力阶段。
- 2026-08-16：合并正文版本绑定阅读标注决策；因 ADR-0021、ADR-0022 已在知识能力分支占用，统一编号为 ADR-0023，语义与实现保持不变。
