...
export type Remediation = {id:string;attemptId:string;replacementQuizId:string;blocks:Block[];objectives:string[];strategy:string;sourceVerification:{url:string;reachable:boolean;statusCode:number;pinned:boolean}[];sourceLineage:{mode:"generation_trace"|"missing";generationRunId:string|null}};
