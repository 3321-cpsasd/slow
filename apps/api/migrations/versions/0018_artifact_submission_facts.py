...
Revision ID: 0018_artifact_submission_facts
Revises: 0017_worker_fencing_and_resume
"""
...
revision = "0018_artifact_submission_facts"
down_revision = "0017_worker_fencing_and_resume"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    for row in rows:
        ...
        connection.execute(
            ...
            {
                "id": f"artifact_submission_migrated_{row['id']}",
