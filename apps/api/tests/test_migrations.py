...
HEAD_REVISION = "0056_knowledge_engine_completion"
...
def test_0055_backfills_rank_qualification_without_rewriting_v2(tmp_path):
    database = tmp_path / "0055-rank-qualification.db"
