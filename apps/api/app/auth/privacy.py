...
PRIVACY_NOTICE_VERSION = "2026-08-12-r3"
...
def privacy_notice() -> dict:
    return {
        ...
        "items": [
            {
                "title": "会处理什么",
                "body": "账号与安全会话、学习画像与目标、书架和教材、阅读与测验记录、答疑、笔记、反馈、页面与关键功能访问、用于估算学习投入的活动时间片、前端异常类型，以及 AI 调用的用量和错误元数据。",
            },
            {
                "title": "为什么处理",
            ...
            {
                "title": "不会做什么",
                "body": "不会公开你的笔记、完整问答、错题或掌握画像，不会出售个人数据，不做鼠标轨迹、会话回放或设备指纹，不记录鼠标位置或按键内容，不把答案、笔记、答疑和反馈正文写入产品埋点，也不会把学习投入估算、埋点或 Demo 数据伪装成学习完成与掌握证据。",
            },
            {
                "title": "保存与退出",
