...
8. model_only 模式不得编造来源、URL 或“已经核验”的表述；没有允许知识主张时不得把案例标为 empirical_case 或 primary_source_case。使用 worked_example、counterexample 或 learner_transfer 时也必须在正文中明确它是抽象推演或假设情境，不能借教学用途标签暗示真实事实。内容可以明确不确定性，但不得声称已通过事实核验。
